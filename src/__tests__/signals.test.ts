...
/**
 * Tracks live listeners by identity rather than by call count: `once: true`
 * detaches on its own, so counting add/remove calls double-counts a listener
 * that both fired and was released.
 */
